...
namespace ApplicationCore.Interfaces
{
    public class ProjectService : IProjectService
    {
        ...
        public async Task<IEnumerable<Project>> GetProjectsByLanguage(int langId)
        {
            ...
            return await projectRepository.FindAll(p => p.Languages.Exists(x => x.LanguageId == langId));
        ...
        public async Task<IEnumerable<Project>> GetProjectsByTech(int techId)
        {
            ...
            return await projectRepository.FindAll(p => p.Technologies.Exists(x => x.TechId == techId));
